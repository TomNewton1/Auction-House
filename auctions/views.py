...
def listing(request, pk):
    ...
    auction_listing = Auction.objects.get(id=pk) # This gets the obj of the current auction
    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST': # User will either post a bid offer or will post comment. 
            ...
            if bid_form.is_valid():
                ...
                if user_bid.price >= auction_listing.price and user_bid.price > auction_listing.highest_bid:
                    ...
                    messages.error(request, "The bid you submitted was not high enough.")
            ...
            user_watchlist = Watchlist.objects.filter(user=(request.user).id, auction=auction_listing.id)
...
def watchlist(request):
    ...
    if request.method == 'POST':
        ...
        if request.POST["to_watchlist"] == "add_to_watchlist":
            ...
            delete_from_watchlist = Watchlist.objects.get(auction=listing, user=(request.user))
...
def categories(request):
    ...
    if request.method == 'POST':
        ...
        print("The selected category is: ", category)

        print("The auctions with this category are: ", auctions)
