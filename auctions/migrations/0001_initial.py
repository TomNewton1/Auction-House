# Generated by Django 3.1.3 on 2021-06-15 07:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default=True, max_length=120)),
                ('price', models.DecimalField(decimal_places=2, default=None, max_digits=10000)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('end_date', models.DateField()),
                ('status', models.CharField(default='Open', max_length=6)),
                ('highest_bid', models.DecimalField(decimal_places=2, default=0, max_digits=10000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default=None, max_digits=100000)),
                ('auction', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='auctions.auction')),
                ('user', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
